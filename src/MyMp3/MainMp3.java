...
public class MainMp3 {
	 ...
	 * 
	 * TestMp3 tMp3 = new TestMp3(); MusicFileBandMaster bigBrother = new
	 * MusicFileBandMaster(DIRECTORY_IN, DIRECTORY_OUT, DIRECTORY_SORT);
	 * 
	 * ArrayList<String> listeFichiers =
	 * bigBrother.getListeFilesMp3(DIRECTORY_IN);
	 * 
	 * System.out.println("----------------------------------------");
	 * System.out.println("n0 " + listeFichiers.get(0));
	 * tMp3.loadMp3Mannuel(DIRECTORY_IN + File.separator +
	 * listeFichiers.get(0));
	 * System.out.println("----------------------------------------");
	 ...
	 * 
	 * File f = new File(DIRECTORY_IN); String[] tabName = f.list();
	 * System.out.println("testFileMetodeList"); afficheTab(tabName);
	 * 
	 * }
	 * 
	 * public static void afficheTab(String[] tab) { if (tab != null) if
	 * (tab.length > 0) for (int i = 0; i < tab.length; i++) {
